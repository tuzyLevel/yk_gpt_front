...
function LoginPage() {
  return (
    <div className="min-h-dvh w-full flex items-center justify-center bg-gray-100 px-4">
      <div className="p-6 sm:p-8 bg-white rounded-lg shadow-md w-full max-w-[400px] mx-auto">
        <h1 className="text-xl sm:text-2xl font-bold text-center mb-6 sm:mb-8">
          ようこそ
        </h1>
        <button
          onClick={() => signIn("google", { prompt: "select_account" })}
          className="w-full flex items-center justify-center gap-2 bg-white border border-gray-300 rounded-lg px-4 sm:px-6 py-3 text-sm font-medium text-gray-800 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors"
        >
